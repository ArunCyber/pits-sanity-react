        ...
        <footer className="text-gray-600 body-font">
            <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col justify-between">
                ...
                <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                    <img className="w-8" src="https://staging.pitsolutions.ch/blog/wp-content/uploads/2021/06/pits-web.svg"></img>
                </a>
                {footer && footer.text && footer.text.length > 0 && (
                    <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
                    {footer.text[0].children[0].text}
                    </p>
                )}
                </span>
                
                <span>
                    {footer && footer.links && Array.isArray(footer.links) && footer.links.map((item, index) => (  
